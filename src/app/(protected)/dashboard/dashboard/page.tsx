  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        toast.error(error instanceof Error ? error.message : 'An error occurred while fetching data');
      } finally {
        setIsLoading(false);
      }
    };
                  ...
                  {filteredTasks.map((task) => (
                    ...
                    >
                      ...
                      <TableCell>
                        ...
                        {task.hasConflict && (
                          <span className="text-red-500 text-xs font-medium ml-2">Conflict</span>
                        )}
                      </TableCell>
                    </TableRow>
                  ))}
